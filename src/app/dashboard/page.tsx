    ...
    <DashboardLayout usage={usage}>
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 py-5 md:p-6 max-w-5xl mx-auto">
          ...
          {usage.limit !== -1 && usage.limit > 0 && usage.scriptsUsed / usage.limit >= 0.8 && (
            <motion.div
              initial={{ opacity: 0, y: -8 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 flex items-center justify-between gap-4 bg-purple-500/10 border border-purple-500/25 rounded-xl px-4 py-3"
            >
