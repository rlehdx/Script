...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      <div className={`overflow-hidden border-t border-white/5 transition-all duration-300 rounded-b-2xl bg-[#0f0f1a]/95 backdrop-blur-xl ${mobileOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
