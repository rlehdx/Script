  ...
  if (displayed.length === 0) {
    return (
      <div className="bezel-card p-10 text-center">
        ...
        <p className="text-slate-300 text-sm font-medium">Create your first script</p>
        <p className="text-slate-600 text-xs mt-1">Enter a topic in the form above and hit Generate.</p>
      </div>
    );
  }
